...
if (count($items) === 0) {
    echo '<div class="mdc-typography--body1 list__no_items">No weapons found' . $year_text . '...</div>';
} else {
    echo '<div class="mdc-typography--caption list__total">' . count($items) . ' weapons' . $year_text . '</div>';
}
