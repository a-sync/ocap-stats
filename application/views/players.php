                        ...
                        <table class="mdc-data-table__table sortable">
                            <thead>
                                <tr class="mdc-data-table__header-row">
                                    ...
                                    <!-- <th class="mdc-data-table__header-cell mdc-data-table__header-cell--numeric" role="columnheader" scope="col" aria-sort="none" data-column-id="adj_shots">Adjusted shots</th> -->
                            ...
                            <tbody class="mdc-data-table__content">
                                ...
                                ?>
                                    <tr class="mdc-data-table__row">
                                        ...
                                        <!-- <td class="mdc-data-table__cell mdc-data-table__cell--numeric"><?php echo $i['adj_shots']; ?></td> -->
                                        ...
                                        <td class="mdc-data-table__cell mdc-data-table__cell--numeric"><?php echo $i['adj_fhits'] !== false ? $i['fhits'] : ''; ?></td>
